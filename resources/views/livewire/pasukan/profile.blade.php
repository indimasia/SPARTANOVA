                            ...
                            <div class="group">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm group-hover:shadow-md transition-shadow duration-200">
                                    ...
                                    <input type="text" id="{{ strtolower($platform->value) }}"
                                        wire:model="sosialMediaAccounts.{{ $platform->value }}"
                                        ...
                                        value="{{ $sosialMediaAccounts[$platform->value] ?? '' }}"
                                        @if(isset($sosialMediaAccounts[$platform->value]) && $sosialMediaAccounts[$platform->value] == 'Tidak punya akun') disabled @endif>
                                </div>
                                <!-- Toggle Button -->
                                <label class="inline-flex items-center mt-2">
                                    <input type="checkbox"
                                        wire:change="$set('sosialMediaAccounts.{{ $platform->value }}', $event.target.checked ? 'Tidak punya akun' : '')"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.addEventListener('livewire:init', function() {
            Livewire.on('notification', function(message) {
