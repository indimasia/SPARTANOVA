<div class="container mx-auto py-8">
    <div class="max-w-lg mx-auto bg-white shadow-md rounded px-8 py-6">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Register Pejuang</h2>
        <form wire:submit.prevent="register">
            ...
            <!-- Social Media -->
            <div class="mb-4">
                <label for="social_media" class="block text-gray-700">Social Media</label>
                <select id="social_media" wire:model="social_media" class="w-full mt-1 px-4 py-2 border rounded-md">
            ...
            <div class="mb-4">
                <label for="social_media_account" class="block text-gray-700">Social Media Username</label>
                <input type="text" id="social_media_account" wire:model="social_media_account"
                    class="w-full mt-1 px-4 py-2 border rounded-md" placeholder="Enter your social media username" />
