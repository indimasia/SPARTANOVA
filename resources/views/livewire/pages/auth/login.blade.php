        ...
        if ($user->hasRole(App\Enums\UserRole::PASUKAN->value) || $user->hasRole(App\Enums\UserRole::PENGIKLAN->value)) {
            if ($user->status != UserStatusEnum::ACTIVE->value) {
                ...
                if ($user->hasRole(App\Enums\UserRole::PASUKAN->value)) {
                    ...
                    session()->flash('status', 'Akun Anda belum diaktivasi. Silakan <a href="' . $whatsappUrl . '" target="_blank" style="color: blue; text-decoration: underline;">klik di sini</a> untuk menghubungi admin melalui WhatsApp.');
                }
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 -mb-16">
        ...
        <div class="bg-gray rounded-xl overflow-hidden">
            <div class="p-8">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-4xl font-bold text-gray-900">Selamat Datang Kembali</h2>
                    <p class="text-gray-600 text-xl mt-2">Masuk ke akun Anda untuk melanjutkan</p>
                </div>
                ...
                <form wire:submit="login" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm text-2xl">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-envelope text-gray-400"></i>
                            </div>
                            <input wire:model="form.email" id="email" type="email" required
                                class="pl-10 block w-full h-16 rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 md:text-base sm:text-2xl"
                                placeholder="nama@email.com">
                        </div>
                        @error('form.email')
                            <p class="mt-1 text-xl text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-xl text-2xl">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input wire:model="form.remember" id="remember" type="checkbox"
                                class="h-5 w-6 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        <button type="submit"
                            class="w-full flex justify-center items-center px-4 py-3 border border-transparent text-lg font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-base text-gray-600">
                            ...
                            <a href="{{ route('register') }}" wire:navigate
                                class="font-medium text-blue-600 text-base hover:text-blue-500">
                                Daftar sekarang
                            </a>
                        </p>
                    </div>
