                      ...
                      <div class="py-4">
                          <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                              <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                                  ...
                                  <div>
                                    <input type="text" wire:model.live="search" class="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="Search articles by title">
                                  </div>
                                        ...
                                        @foreach ($articles as $article)
                                          <div class="px-4 py-4 sm:px-6">
                                            <a href="{{ route('articles.detail', $article->slug) }}" class="block">
                                              <div class="flex items-center justify-between cursor-pointer" wire:click="goToDetail({{ $article->slug }})">
                                              ...
                                              <div class="mt-2 sm:flex sm:justify-between">
                                                  <div class="sm:flex">
                                                      <p class="flex items-center text-sm text-gray-500">
                                                          <i class="fas fa-user flex items-center mr-1.5 h-5 w-5 text-yellow-700"></i>
                                                          John Doe
                                                      </p>
                                                      <p class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
                                                          <i class="fas fa-calendar-alt flex items-center mr-1.5 h-5 w-5 text-yellow-700"></i>
                                                          {{ $article->published_at }}
                                                      </p>
                                                  </div>
                                                  <div class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                                                      <i class="fas fa-eye flex items-center mr-1.5 h-5 w-5 text-yellow-700"></i>
                                                      <p>
                                                          1.2k views
                                                      </p>
                                                  </div>
