<x-filament-widgets::widget>
    <x-filament::section>
                ...
                <h3 class="text-xl font-semibold">Pengumuman</h3>
                    ...
                    <div  class="flex overflow-y-auto flex-col mb-5 items-center bg-white border border-gray-200 gap-4 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 !important" style=" max-height: 42rem;">
